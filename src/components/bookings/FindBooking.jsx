    ...
    const handleFormSubmit = async (event) => {
        ...
        try {
            ...
            if (error.response && error.response.status === 404) {
                setError(error.response.data.message) // data.message 是后台存放异常的地方new ResourceNotFoundException("No booking found with booking code:" +confirmationCode));
            } else {
            ...
            <div className="container mt-5 d-flex flex-column justify-content-center align-items-center">
                ...
                {isLoading ? (
                    ...
                    <div className="col-md-6 mt-4 mb-5">
                        ...
                        <p>
                            Check-in Date:{" "}
                            {/*subtract(1, "month") 的作用是将指定的日期减去一个月。*/}
